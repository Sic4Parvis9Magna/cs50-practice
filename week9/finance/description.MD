...
## Screencast
Record a screencast (about 2 minutes in length) with voiceover in which you demonstrate your web application and its features. Upload your videos to YouTube as “public” or “unlisted” and take note of its URL.
...
* If `str` is an `INSERT`, and the table into which data was inserted contains an incrementing `PRIMARY KEY`, then  `execute` returns the value of the newly inserted row’s primary key.
...
* You’re welcome to alter the aesthetics of the sites, as via
    ...
    * [https://getbootstrap.com/docs/4.1/content/](https://getbootstrap.com/docs/4.1/content/),
    * [https://getbootstrap.com/docs/4.1/components/](https://getbootstrap.com/docs/4.1/components/), and/or
    * [https://memegen.link/](https://memegen.link/).
...
```
submit50 cs50/problems/2020/spring/finance
```